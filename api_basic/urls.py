...
urlpatterns = [
    ...
    path('detail/<int:id>', ArticleDetails.as_view()),          #Class based
    path('generic/article/<int:id>/', GenericAPIView.as_view()),         #Generic Based
    #path('generic/detail/<int:id>/', GenericAPIView.as_view()),  #Generic Based
